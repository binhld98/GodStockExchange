...
public sealed class OrderCancelReplaceRequestTests
{
    private readonly Validator _validator;

    public OrderCancelReplaceRequestTests()
    {
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(side: side));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.MARKET, price: null));
        AssertSuccess(actual);
    }
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: 330m));
        AssertSuccess(actual);
    }
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(timeInForce: timeInForce));
        AssertSuccess(actual);
    }
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(quantity: quantity));
        AssertSuccess(actual);
    }
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: price));
        AssertSuccess(actual);
    }
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(orderType: orderType));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(timeInForce: null));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(symbol: "!@#$"));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(symbol: "NVDA"));
    ...
    {
        var message = FixMessageFactory.CancelReplace();
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(quantity: null));
    ...
    {
        var actual1 = _validator.Validate(FixMessageFactory.CancelReplace(quantity: 0m));
        AssertFailure(actual1, ErrorCode.NonPositiveOrderQuantity, OrderQty.TAG);

        var actual2 = _validator.Validate(FixMessageFactory.CancelReplace(quantity: -10m));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(quantity: 10.5m));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(quantity: decimal.MaxValue));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(quantity: 101m));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(quantity: 100100m));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.MARKET, price: 300m));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: null));
    ...
    {
        var actual1 = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: 0));
        AssertFailure(actual1, ErrorCode.NonPositivePrice, Price.TAG);
        
        var actual2 = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: -0.01m));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: 300.001m));
    ...
    {
        var actual1 = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: 299.01m));
        AssertFailure(actual1, ErrorCode.PriceOutsideBand, Price.TAG);
        
        var actual2 = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: 360.01m));
        AssertFailure(actual2, ErrorCode.PriceOutsideBand, Price.TAG);
        
        var actual3 = _validator.Validate(FixMessageFactory.CancelReplace(orderType: OrdType.LIMIT, price: decimal.MaxValue));
