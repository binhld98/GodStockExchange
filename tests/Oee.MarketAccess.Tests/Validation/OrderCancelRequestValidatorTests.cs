...
public class OrderCancelRequestValidatorTests
{
    private readonly Validator _validator;

    public OrderCancelRequestValidatorTests()
    {
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.Cancel(side: side));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.Cancel(symbol: "!@#$"));
    ...
    {
        var actual = _validator.Validate(FixMessageFactory.Cancel(symbol: "NVDA"));
